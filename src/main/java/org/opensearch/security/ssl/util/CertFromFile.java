 ...
 */
 ...
 public class CertFromFile {
     ...
     public CertFromFile(CertFileProps clientCertProps, CertFileProps serverCertProps) throws Exception {
         ...
         loadedCA = new X509Certificate[]{PemKeyReader.loadCertificateFromFile(serverCertProps.getTrustedCasFilePath())};
     }
     ...
     public CertFromFile(CertFileProps certProps) throws Exception {
         ...
         loadedCA = new X509Certificate[]{PemKeyReader.loadCertificateFromFile(certProps.getTrustedCasFilePath())};
     }
